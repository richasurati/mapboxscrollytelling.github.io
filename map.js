...
map.on("load", function () {
  ...
  map.addLayer({
    id: "streetgrid", // Unique ID for the layer
    type: "line", // Type of layer (e.g., fill, line, circle)
    source: {
      type: "geojson", // Type of data source (e.g., geojson, vector tile, raster tile)
      data: "data/DCM.geojson", // Path to your GeoJSON data file
    },
    paint: {
      // Paint properties for styling the layer
      "line-opacity": 0.15, // Example opacity value
      "line-color": "#ffba08", // Example fill color
...
map.addLayer({
  id: "freshfoodstores", // Unique ID for the layer
  type: "fill", // Type of layer (e.g., fill, line, circle)
  source: {
    type: "geojson", // Type of data source (e.g., geojson, vector tile, raster tile)
    data: "data/freshfoodstores.geojson", // Path to your GeoJSON data file
  },
  paint: {
    // Paint properties for styling the layer
    "fill-opacity": 0.25, // Example opacity value
    "fill-color": "#eae2b7", // Example fill color
    // Add other paint properties as needed
  },
},
"hillshade"
...
map.addLayer({
  id: "bid", // Unique ID for the layer
  type: "fill", // Type of layer (e.g., fill, line, circle)
  source: {
    type: "geojson", // Type of data source (e.g., geojson, vector tile, raster tile)
    data: "data/bid.geojson", // Path to your GeoJSON data file
  },
  paint: {
    // Paint properties for styling the layer
    "fill-opacity": 0.5, // Example opacity value
    "fill-color": "#e33f26", // Example fill color
    // Add other paint properties as needed
  },
},
"hillshade"
...
map.addLayer({
  id: "communitygarden", // Unique ID for the layer
  type: "fill", // Type of layer (e.g., fill, line, circle)
  source: {
    type: "geojson", // Type of data source (e.g., geojson, vector tile, raster tile)
    data: "data/GreenGarden.geojson", // Path to your GeoJSON data file
  },
  paint: {
    // Paint properties for styling the layer
    "fill-opacity": 0.5, // Example opacity value
    "fill-color": "#81e39a", // Example fill color
    // Add other paint properties as needed
  },
},
"road-label-simple"
...
map.addLayer({
  id: "local_business", // Unique ID for the layer
  type: "circle", // Type of layer (point data)
  source: {
    type: "geojson", // Type of data source (e.g., geojson, vector tile, raster tile)
    data: "data/03_localbusiness.geojson" // Path to your GeoJSON data file
  },
  paint: {
    // Paint properties for styling the circle layer
    "circle-opacity": 0.5, // Example opacity value
    "circle-color": "#f77f00", // Example circle color
    "circle-radius": [
      "interpolate",
      ["linear"],
      ["zoom"],
      // Define circle sizes for different zoom levels
      0, 1, // Example radius at zoom level 0
      5, 1, // Example radius at zoom level 5
      10, 2, // Example radius at zoom level 10
      15, 10, // Example radius at zoom level 15
      20, 15 // Example radius at zoom level 20
    ] // Example circle radius // Example circle radius
    // Add other paint properties as needed
  }
},
"road-label-simple"
...
map.addLayer({
  id: "open_restaurant", // Unique ID for the layer
  type: "circle", // Type of layer (point data)
  source: {
    type: "geojson", // Type of data source (e.g., geojson, vector tile, raster tile)
    data: "data/05_open_restaurant.geojson" // Path to your GeoJSON data file
  },
  paint: {
    // Paint properties for styling the circle layer
    "circle-opacity": 0.5, // Example opacity value
    "circle-color": "#9b2226", // Example circle color
    "circle-radius": [
      "interpolate",
      ["linear"],
      ["zoom"],
...
map.addLayer({
  id: "Veteran_business", // Unique ID for the layer
  type: "circle", // Type of layer (point data)
  source: {
    type: "geojson", // Type of data source (e.g., geojson, vector tile, raster tile)
    data: "data/06_Veteran_business.geojson" // Path to your GeoJSON data file
  },
  paint: {
    // Paint properties for styling the circle layer
    "circle-opacity": 0.5, // Example opacity value
    "circle-color": "#ee9b00", // Example circle color
    "circle-radius": [
      "interpolate",
      ["linear"],
      ["zoom"],
...
map.addLayer({
  id: "farmersmarket", // Unique ID for the layer
  type: "circle", // Type of layer (point data)
  source: {
    type: "geojson", // Type of data source (e.g., geojson, vector tile, raster tile)
    data: "data/08_farmersmarket_.geojson" // Path to your GeoJSON data file
  },
  paint: {
    // Paint properties for styling the circle layer
    "circle-opacity": 0.5, // Example opacity value
    "circle-color": "#94d2bd", // Example circle color
    "circle-radius": [
      "interpolate",
      ["linear"],
      ["zoom"],
      ...
      0, 1, // Example radius at zoom level 0
      5, 1, // Example radius at zoom level 5
      10, 1.5, // Example radius at zoom level 10
      15, 10, // Example radius at zoom level 15
      20, 15 // Example radius at zoom level 20
...
map.addLayer({
  id: "foodscrapoff", // Unique ID for the layer
  type: "circle", // Type of layer (point data)
  source: {
    type: "geojson", // Type of data source (e.g., geojson, vector tile, raster tile)
    data: "data/FoodScrap.geojson" // Path to your GeoJSON data file
  },
  paint: {
    // Paint properties for styling the circle layer
    "circle-opacity": 0.5, // Example opacity value
    "circle-color": "#ffb3c6", // Example circle color
    "circle-radius": [
      "interpolate",
      ["linear"],
      ["zoom"],
  ...
  map.addLayer(
    {
      ...
      paint: {
        // Paint properties for styling the circle layer
        "circle-opacity": 0.5, // Example opacity value
        "circle-color": "#ade8f4", // Example circle color
        "circle-radius": [
          "interpolate",
          ["linear"],
          ["zoom"],
          ...
          0, 1, // Example radius at zoom level 0
          5, 1, // Example radius at zoom level 5
          10, 1.8, // Example radius at zoom level 10
          15, 10, // Example radius at zoom level 15
          20, 15 // Example radius at zoom level 20
        ] // Example circle radius
        // Add other paint properties as needed
